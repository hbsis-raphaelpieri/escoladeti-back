...
%JAVA_CMD% -cp bin\flyway-commandline-3.0.jar;bin\flyway-core-3.0.jar org.flywaydb.commandline.Main -configFile=./conf/flyway-sqlserver-testes-integracao.properties -locations=filesystem:./sql/sqlserver,filesystem:./sql/common %* -consoleWidth=%CONSOLE_WIDTH%
